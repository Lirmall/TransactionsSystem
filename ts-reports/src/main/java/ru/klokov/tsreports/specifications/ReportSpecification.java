...
public class ReportSpecification implements Specification<ReportEntity> {
    ...
    @Override
    public Predicate toPredicate(Root<ReportEntity> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
    ...
    private Predicate localDateTimeHandler(Object date, Root<ReportEntity> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
